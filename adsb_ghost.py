...
<flow_graph>
  ...
  <block>
    ...
    <param>
      <key>id</key>
      <value>klm_data</value>
    </param>
    <param>
      <key>value</key>
      <value>0x8D4840D6202CC371C32CE0576098</value>
    </param>
  </block>
  <block>
    <key>variable</key>
  ...
  <block>
    ...
    <param>
      <key>vector</key>
      <value>tuple(int(x) for x in bin(klm_data)[2:])</value>
    </param>
  </block>
  <block>
    <key>blocks_vector_source_x</key>
  ...
  <block>
    ...
    <param>
      <key>_io_cache</key>
      <value>('PPM mapper', 'blk', [], [('0', 'int')], [('0', 'int')], 'Embedded Python Block example - a simple multiply const', [])</value>
    </param>
    <param>
