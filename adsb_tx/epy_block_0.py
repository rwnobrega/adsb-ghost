...
class blk(gr.basic_block):  # other base classes are basic_block, decim_block, interp_block
	...
	if not self.int_to_return:
		...
		list_value = []
	    	...
	    	def travel(coordinates, alt, icao, current_latitude, current_longitude, plan = None, name = None):
	    		# global plan
		...
		while lock == True:
		    ...
		    for i in range(len(a)):
		        ...
		        if list_command[i] == 'travel':
		            ...
		            travel(destiny_coordinates, alts, icao, current_latitude, current_longitude, plan)
			...
			if list_command[i] == 'name':
			    ...
			    print(alts)
		       	    travel(destiny_coordinates, alts, message, current_latitude, current_longitude, plan)
